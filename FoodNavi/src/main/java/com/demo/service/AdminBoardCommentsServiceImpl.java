...
import com.demo.persistence.AdminBoardCommentsRepository;

@Service
public class AdminBoardCommentsServiceImpl implements AdminBoardCommentsService {

	@Autowired
	AdminBoardCommentsRepository BoardCommentsRepo;
